...
// ContainerFailures keeps track of restart and failure information.
...
// PodRunningReadyOrSucceeded checks whether pod p has already succeeded or has a ready condition of status true.
